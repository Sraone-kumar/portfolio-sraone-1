...
export default function ProjectsV2({ li }) {
  ...
  return (
    <div
      ref={projectRef}
      className="min-h-screen items-center w-full bg-black flex flex-col"
    >
      <div className="text-3xl mb-10 text-white">{info.projects.name}</div>
